...
typedef int __gcc_v8si;
typedef int __gcc_v16qi;
typedef int __gcc_v4sf;
typedef int __gcc_v8hi;
typedef float __float128;
typedef int __gcc_v4si;
typedef int __gcc_v2df;
typedef int __gcc_v2df;
typedef int __gcc_v2di;
typedef int __gcc_v4df;
typedef int __gcc_v8sf;
typedef int __gcc_v32qi;
typedef int __gcc_v4di;
typedef int __gcc_v16hi;
typedef int __gcc_v32hi;
typedef int __gcc_v2sf;
typedef int v4si;
typedef int v4sf;
typedef int v2df;
typedef int v2di;
extern v4si __builtin_ia32_cmpnltss (v4sf, v4sf);
extern v8qi __builtin_ia32_paddb (v8qi, v8qi);
extern v4hi __builtin_ia32_paddw (v4hi, v4hi);
extern v2si __builtin_ia32_paddd (v2si, v2si);
extern v8qi __builtin_ia32_psubb (v8qi, v8qi);
extern v4hi __builtin_ia32_psubw (v4hi, v4hi);
extern v2si __builtin_ia32_psubd (v2si, v2si);
extern v8qi __builtin_ia32_paddsb (v8qi, v8qi);
extern v4hi __builtin_ia32_paddsw (v4hi, v4hi);
extern v8qi __builtin_ia32_psubsb (v8qi, v8qi);
extern v4hi __builtin_ia32_psubsw (v4hi, v4hi);
extern v8qi __builtin_ia32_paddusb (v8qi, v8qi);
extern v4hi __builtin_ia32_paddusw (v4hi, v4hi);
extern v8qi __builtin_ia32_psubusb (v8qi, v8qi);
extern v4hi __builtin_ia32_psubusw (v4hi, v4hi);
extern v4hi __builtin_ia32_pmullw (v4hi, v4hi);
extern v4hi __builtin_ia32_pmulhw (v4hi, v4hi);
extern di __builtin_ia32_pand (di, di);
extern di __builtin_ia32_pandn (di,di);
extern di __builtin_ia32_por (di, di);
extern di __builtin_ia32_pxor (di, di);
extern v8qi __builtin_ia32_pcmpeqb (v8qi, v8qi);
extern v4hi __builtin_ia32_pcmpeqw (v4hi, v4hi);
extern v2si __builtin_ia32_pcmpeqd (v2si, v2si);
extern v8qi __builtin_ia32_pcmpgtb (v8qi, v8qi);
extern v4hi __builtin_ia32_pcmpgtw (v4hi, v4hi);
extern v2si __builtin_ia32_pcmpgtd (v2si, v2si);
extern v8qi __builtin_ia32_punpckhbw (v8qi, v8qi);
extern v4hi __builtin_ia32_punpckhwd (v4hi, v4hi);
extern v2si __builtin_ia32_punpckhdq (v2si, v2si);
extern v8qi __builtin_ia32_punpcklbw (v8qi, v8qi);
extern v4hi __builtin_ia32_punpcklwd (v4hi, v4hi);
extern v2si __builtin_ia32_punpckldq (v2si, v2si);
extern v8qi __builtin_ia32_packsswb (v4hi, v4hi);
extern v4hi __builtin_ia32_packssdw (v2si, v2si);
extern v8qi __builtin_ia32_packuswb (v4hi, v4hi);
extern v4hi __builtin_ia32_psllw (v4hi, v4hi);
extern v2si __builtin_ia32_pslld (v2si, v2si);
extern v1di __builtin_ia32_psllq (v1di, v1di);
extern v4hi __builtin_ia32_psrlw (v4hi, v4hi);
extern v2si __builtin_ia32_psrld (v2si, v2si);
extern v1di __builtin_ia32_psrlq (v1di, v1di);
extern v4hi __builtin_ia32_psraw (v4hi, v4hi);
extern v2si __builtin_ia32_psrad (v2si, v2si);
extern v4hi __builtin_ia32_psllwi (v4hi, int);
extern v2si __builtin_ia32_pslldi (v2si, int);
extern v1di __builtin_ia32_psllqi (v1di, int);
extern v4hi __builtin_ia32_psrlwi (v4hi, int);
extern v2si __builtin_ia32_psrldi (v2si, int);
extern v1di __builtin_ia32_psrlqi (v1di, int);
extern v4hi __builtin_ia32_psrawi (v4hi, int);
extern v2si __builtin_ia32_psradi (v2si, int);
...
extern float __builtin_ia32_vec_ext_v4sf (v4sf, const int);
extern v2df __builtin_ia32_vec_ext_v2df (v2df, int);
extern  v4si __builtin_ia32_vec_ext_v4si (v4si, int);
extern  v2di __builtin_ia32_vec_ext_v2di (v2di, int);
